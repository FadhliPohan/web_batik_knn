	...
	<div>
		...
		<table width="98%" border="0">
			...
			if ($jpenjualan > 0) {
				...
				<td>$kategori</td>
				<td><div align='center'>
<a href='?mnu=knn&pro=hapus&kode=$id&id_pengujian=$id_pengujian'><img src='ypathicon/ha.png' title='hapus' 
onClick='return confirm(\"Apakah Anda benar-benar akan menghapus data \"$motif\" pada data pengujian $nama_toko?..\")'></a></div></td>
		...
		$gab1 = "<h4>Hitung Jarak Eccludean Distance data '$nama_$toko | $id_toko'</h4>
<b><i>$lap</b></i>
<table width='95%'>
  <tr bgcolor='#036'>
