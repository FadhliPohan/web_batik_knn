...
<a href="downloadget.php?nf=Semua_datalatih.xls">		
		<input type="button" id="import"  class="btn btn-danger" value="DOWNLOAD" name="DOWNLOAD"/></a></td></tr>
		</table>
		</form>
		<hr>
...
<td>:<td colspan="5"><select name="id_toko" class="form-control" id="id_toko">
  <?php  
...
<td valign="top">:<td colspan="7">
<select name="motif" class="form-control" id="motif">
<option value="-">Pilih Motif</option>
<option value="Sari Gading" <?php if($motif=="Sari Gading"){echo "selected";} ?>>Sari Gading</option>
<option value="Kulat Karikit" <?php if($motif=="Kulat Karikit"){echo "selected";} ?>>Kulat Karikit</option>
<option value="Bintang Berhambur" <?php if($motif=="Bintang Berhambur"){echo "selected";} ?>>Bintang Berhambur</option>
<option value="Bintang Berhambur" <?php if($motif=="Bintang Berhambur"){echo "selected";} ?>>Bintang Berhambur</option>
<option value="Bayam Raja" <?php if($motif=="Bayam Raja"){echo "selected";} ?>>Bayam Raja</option>
<option value="Awan Beriring" <?php if($motif=="Awan Beriring"){echo "selected";} ?>>Awan Beriring</option>
<option value="Getas" <?php if($motif=="Getas"){echo "selected";} ?>>Getas</option>
<option value="Jumputan" <?php if($motif=="Jumputan"){echo "selected";} ?>>Jumputan</option>
<option value="Gigi Haruan" <?php if($motif=="Gigi Haruan"){echo "selected";} ?>>Gigi Haruan</option>
</select>
</td></tr>
...
<td>:<td colspan="5">
<input type="radio" name="kategori" id="kategori"  checked="checked" value="rendah" <?php if($kategori=="rendah"){echo"checked";}?>/>Rendah 
<input type="radio" name="kategori" id="kategori" value="Sedang" <?php if($kategori=="Sedang"){echo"checked";}?>/>Sedang
<input type="radio" name="kategori" id="kategori" value="tinggi" <?php if($kategori=="tinggi"){echo"checked";}?>/>Tinggi
...
<td>:<td><input   name="keterangan" type="text" class="form-control" id="keterangan" value="<?php echo $keterangan;?>" />
</td>
</tr>
<tr>
<td>
...
if($jmldata>0){
	...
	for($i=1;$i<=$jmlhal;$i++)
	if ($i != $page){echo "<a href='$_SERVER[PHP_SELF]?page=$i&mnu=penjualan'>$i</a> ";}
...
$simpan=process($conn,$sql);
	if($simpan) {echo "<script>alert('Data \"$id_toko\" berhasil disimpan !');document.location.href='?mnu=penjualan';</script>";}
		else{echo"<script>alert('Data \"$id_toko\" gagal disimpan...');document.location.href='?mnu=penjualan';</script>";}
	}
	else{
	...
	$ubah=process($conn,$sql);
		if($ubah) {echo "<script>alert('Data berhasil diubah !');document.location.href='?mnu=penjualan';</script>";}
		else{echo"<script>alert('Data  gagal diubah...');document.location.href='?mnu=penjualan';</script>";}
	}//else simpan
}
?>
...
$hapus=process($conn,$sql);
	if($hapus) {echo "<script>alert('Data berhasil dihapus !');document.location.href='?mnu=penjualan';</script>";}
	else{echo"<script>alert('Data gagal dihapus...');document.location.href='?mnu=penjualan';</script>";}
}
?>
